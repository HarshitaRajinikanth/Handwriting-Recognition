The link for the dataset is available in Kaggle: https://www.kaggle.com/datasets/landlord/handwriting-recognition. It is a 1GB dataset with train, test and validation data
